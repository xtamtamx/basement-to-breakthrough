...
export const AchievementSynergyPanel: React.FC<
  AchievementSynergyPanelProps
> = ({ isOpen, onClose }) => {
  const [selectedTab, setSelectedTab] = useState<"unlocked" | "locked">(
    "unlocked",
  );

  const unlockedSynergies =
    achievementSynergySystem.getAvailableAchievementSynergies();
  const nearlyUnlockedSynergies =
    achievementSynergySystem.getNearlyUnlockedSynergies();
          ...
          >
            ...
            <div className="p-4 border-b border-metal-700">
              <div className="flex justify-between items-center">
                <h2
                  className="punk-headline text-2xl"
                          ...
                          <div className="flex-1">
                            ...
                            <div className="mb-2">
                              <div className="flex justify-between items-center mb-1">
                                ...
                                >
                                  {achievementSynergySystem.getSynergyRequirementDescription(
                                    synergy.id,
                                  )}
                                </span>
                                <span
            ...
            <div className="p-4 border-t border-metal-700">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  >
                    {unlockedSynergies.length} /{" "}
                    {unlockedSynergies.length + nearlyUnlockedSynergies.length}
                  </p>
                </div>
                <div className="text-right">
                  ...
                  >
                    {unlockedSynergies.reduce(
                      (sum, s) => sum + s.effects.length,
                      0,
                    )}{" "}
                    EFFECTS
                  </p>
