...
import { Band, Bill } from "@game/types";
        ...
        <div className="space-y-3">
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <span
                className="pixel-text pixel-text-xs"
                style={{ color: getDynamicsColor(dynamics.chemistryScore) }}
              >
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <span
                className="pixel-text pixel-text-xs"
                style={{ color: getDynamicsColor(dynamics.crowdAppeal) }}
              >
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <span
                className="pixel-text pixel-text-xs"
                style={{ color: getDynamicsColor(dynamics.sceneAlignment) }}
              >
