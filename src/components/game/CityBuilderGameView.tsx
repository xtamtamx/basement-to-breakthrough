...
const initialVenues: Venue[] = [
  {
    ...
    atmosphere: 85,
    modifiers: [],
    location: { id: 'eastside', name: 'Eastside', sceneStrength: 80, gentrificationLevel: 30, policePresence: 20, rentMultiplier: 1, bounds: { x: 0, y: 0, width: 4, height: 4 }, color: '#ec4899' },
    rent: 0,
    equipment: [],
    allowsAllAges: true,
    hasBar: false,
  ...
  },
  {
    ...
    atmosphere: 70,
    modifiers: [],
    location: { id: 'downtown', name: 'Downtown', sceneStrength: 60, gentrificationLevel: 70, policePresence: 50, rentMultiplier: 1.5, bounds: { x: 4, y: 0, width: 4, height: 4 }, color: '#3b82f6' },
    rent: 150,
    equipment: [],
    allowsAllAges: false,
    hasBar: true,
  ...
  },
  {
    ...
    atmosphere: 95,
    modifiers: [],
    location: { id: 'industrial', name: 'Industrial', sceneStrength: 70, gentrificationLevel: 20, policePresence: 60, rentMultiplier: 0.8, bounds: { x: 0, y: 4, width: 4, height: 4 }, color: '#10b981' },
    rent: 300,
    equipment: [],
    allowsAllAges: true,
    hasBar: false,
...
export const CityBuilderGameView: React.FC = () => {
  const { money, reputation, fans, venues, updateVenues, addVenue } = useGameStore();
          ...
          >
            ...
            >
              ...
              <div style={{
                ...
                Capacity: {selectedVenue.capacity} • Authenticity: {selectedVenue.authenticity}
              </div>
              <div style={{
                display: 'flex',
                flexDirection: 'column',
                ...
                {bandHand.map(band => (
                  ...
                  >
                    ...
                    <div style={{ fontSize: '12px', color: '#9ca3af' }}>
                      Cost: $50 • Expected Draw: {Math.floor(band.popularity * selectedVenue.capacity / 100)}
                    </div>
                  </button>
                ))}
              </div>
