    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '30px', alignItems: 'center' }}>
          <h1 style={{ color: '#ec4899', fontSize: '24px', margin: 0 }}>BOOK SHOWS</h1>
      ...
      <div style={{
              ...
              return (
                ...
                >
                  ...
                  <p style={{ color: '#9ca3af', margin: 0, fontSize: '14px' }}>
                    {isBooked ? 'BOOKED' : `Cap: ${venue.capacity} | $${venue.rent}`}
                  </p>
                </div>
              );
            })}
        ...
        <div style={{
          ...
          <div style={{
            ...
            {bands.map(band => {
              const isBooked = Array.from(bookedShows.values()).some(b => b.id === band.id);
              ...
              return (
                <div
                  ...
                  style={{
                    padding: '12px',
                    backgroundColor: isBooked ? '#374151' : isSelected ? '#7c2d12' : '#2d2d2d',
                ...
                >
                  <h4 style={{ color: 'white', margin: '0 0 3px 0', fontSize: '14px' }}>
                    {band.name}
                  </h4>
