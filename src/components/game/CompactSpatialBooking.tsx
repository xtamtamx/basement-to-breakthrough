...
export const CompactSpatialBooking: React.FC<CompactSpatialBookingProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex flex-col" style={{ backgroundColor: '#0F0F0F' }}>
      {/* Header Bar */}
      ...
      <div className="flex-1 flex p-4 gap-4 overflow-hidden">
        ...
        <div className="w-1/2 flex flex-col">
          <h2 className="text-lg font-bold mb-3" style={{ color: '#ec4899' }}>VENUES</h2>
                ...
                >
                  ...
                  {isBooked && (
                    <div className="mt-2 text-xs" style={{ color: '#10b981' }}>
                      ✓ {bookedBands.length} band{bookedBands.length > 1 ? 's' : ''}
                    </div>
                  )}
                </motion.div>
              );
        ...
        <div className="w-1/2 flex flex-col">
          <h2 className="text-lg font-bold mb-3" style={{ color: '#ec4899' }}>BANDS</h2>
            ...
            {bands.map((band) => {
              ...
              return (
                ...
                >
                  ...
                  {isBooked && (
                    <span className="text-xs" style={{ color: '#6b7280' }}>BOOKED</span>
                  )}
                  {isSelected && !isBooked && (
      ...
      <div className="h-10 flex items-center justify-center px-6" style={{ 
        backgroundColor: 'rgba(30, 30, 30, 0.95)',
