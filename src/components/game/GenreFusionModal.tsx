...
export const GenreFusionModal: React.FC<GenreFusionModalProps> = ({
  ...
  const [choice, setChoice] = useState<'supergroup' | 'sideproject' | null>(null);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <h3 className="pixel-text pixel-text-sm text-center mb-3" style={{ color: 'var(--pixel-yellow)' }}>
                {fusion.name.toUpperCase()}
              </h3>
              
              <p className="pixel-text pixel-text-xs text-center mb-3" style={{ color: 'var(--pixel-white)' }}>
                {fusion.description}
              </p>
              
              <p className="pixel-text text-center mb-4" style={{ fontSize: '8px', color: 'var(--pixel-gray)', fontStyle: 'italic' }}>
                "{fusion.flavorText}"
              </p>
              ...
              {fusion.bonusTraits.length > 0 && (
                <div className="mt-3">
                  <p className="pixel-text text-center mb-1" style={{ fontSize: '8px', color: 'var(--pixel-cyan)' }}>
                    NEW TRAITS:
                  </p>
            ...
            >
              <button
                ...
                style={{
                  background: choice === 'supergroup' ? 'var(--pixel-green)' :
              ...
              >
                ...
                <p className="pixel-text mt-1" style={{ fontSize: '8px', opacity: 0.8 }}>
              ...
              <button
                ...
                className="w-full glass-button p-3"
                style={{
                  background: choice === 'sideproject' ? 'var(--pixel-green)' :
              ...
              >
                <div className="text-center">
                  ...
                  <p className="pixel-text pixel-text-lg" style={{ color: 'var(--pixel-green)' }}>
                    CREATING {choice === 'supergroup' ? 'SUPERGROUP' : 'SIDE PROJECT'}...
                  </p>
                </div>
              </motion.div>
            )}
