...
export const MapBasedBooking: React.FC<MapBasedBookingProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex flex-col" style={{ backgroundColor: '#1a1a1a' }}>
      {/* Top Bar */}
      <div className="h-12 flex items-center justify-between px-4" style={{ 
        backgroundColor: 'rgba(0, 0, 0, 0.8)',
        borderBottom: '1px solid rgba(236, 72, 153, 0.3)'
      }}>
        <div className="flex items-center gap-6">
          <h1 className="text-lg font-bold" style={{ color: '#ec4899' }}>BOOK SHOWS</h1>
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <div className="absolute inset-0" style={{
          background: 'linear-gradient(to bottom right, #2a2a2a, #1a1a1a, #2a2a2a)'
        }}>
          {/* Grid overlay */}
          <div className="absolute inset-0" style={{
            opacity: 0.2,
            ...
            >
              ...
              >
                ...
                <div 
                  ...
                  style={{
                    backgroundColor: isBooked ? 'rgba(16, 185, 129, 0.4)' : 'rgba(45, 45, 45, 0.95)',
                    border: `3px solid ${
                      isBooked ? '#10b981' : 
                      hoveredVenue === venue.id ? '#ec4899' : 
                      'rgba(236, 72, 153, 0.5)'
                    }`,
                    borderStyle: draggedBand && !isBooked ? 'dashed' : 'solid',
                    boxShadow: hoveredVenue === venue.id ? '0 0 30px rgba(236, 72, 153, 0.7)' : 
                              isBooked ? '0 0 20px rgba(16, 185, 129, 0.7)' : 
                ...
                <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 whitespace-nowrap text-center">
                  <p className="text-xs font-bold" style={{ color: '#ffffff', textShadow: '0 1px 2px rgba(0,0,0,0.8)' }}>
                    {venue.name}
                  </p>
                  <p className="text-xs" style={{ color: isBooked ? '#10b981' : '#9ca3af' }}>
        ...
        <svg className="absolute inset-0 pointer-events-none">
          ...
          <line
            ...
            stroke="rgba(236,72,153,0.3)" strokeWidth="2"
            strokeDasharray="5,5"
            opacity="0.5"
          />
          <line
            x1="40%" y1="35%" x2="65%" y2="15%"
            stroke="rgba(236,72,153,0.3)" strokeWidth="2"
            strokeDasharray="5,5"
            opacity="0.5"
          />
          <line
            x1="40%" y1="35%" x2="20%" y2="55%"
            stroke="rgba(236,72,153,0.3)" strokeWidth="2"
            strokeDasharray="5,5"
            opacity="0.5"
          />
            ...
            return (
              ...
              >
                <div 
                  ...
                  style={{
                    backgroundColor: isBooked ? 'rgba(75, 75, 75, 0.5)' : 
                                   isSelected ? 'rgba(236, 72, 153, 0.4)' : 
                                   'rgba(30, 30, 30, 0.95)',
                    border: `2px solid ${
                      isSelected ? '#ec4899' : 
                      isBooked ? '#4b5563' : 
                    ...
                    boxShadow: isSelected ? '0 0 20px rgba(236, 72, 153, 0.5)' : 'none'
                  }}
                >
