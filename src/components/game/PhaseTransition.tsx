...
> = {
  [GamePhase.MENU]: {
    ...
    color: "var(--punk-neon-purple)",
  },
  [GamePhase.SETUP]: {
    title: "SETUP",
    subtitle: "Preparing your scene",
    color: "var(--punk-neon-cyan)",
  },
  [GamePhase.PLANNING]: {
    title: "BOOKING PHASE",
    subtitle: "Build your lineups",
    color: "var(--pixel-yellow)",
  },
  [GamePhase.BOOKING]: {
    title: "BOOKING",
    subtitle: "Securing venues",
  ...
  [GamePhase.PERFORMANCE]: {
    title: "SHOWTIME",
    subtitle: "The bands take the stage",
    color: "var(--pixel-red)",
  },
  [GamePhase.SHOW_NIGHT]: {
    title: "SHOW NIGHT",
    subtitle: "Live from the underground",
    color: "var(--punk-neon-purple)",
  },
  [GamePhase.AFTERMATH]: {
    title: "AFTERMATH",
    subtitle: "Counting the damage",
    color: "var(--pixel-magenta)",
  },
  [GamePhase.SCENE_POLITICS]: {
    title: "SCENE POLITICS",
    subtitle: "Navigate the drama",
    color: "var(--pixel-blue)",
  },
  [GamePhase.GAME_OVER]: {
    title: "GAME OVER",
    subtitle: "The scene remembers",
    color: "var(--pixel-red)",
  },
};
