...
export const STARTER_SYNERGIES: Synergy[] = [
  ...
  // ===== Expansion jokers (2026-06-21): more slot-fill decisions + new builds =====
  {
    id: 'merch_maven',
    name: 'Merch Maven',
    description: 'The folding table out-earns the door',
    rarity: 'COMMON',
    trigger: 'SHOW_END',
  ...
  },
  {
    id: 'early_bird',
    name: 'First-Mover',
    description: 'Get loud before anyone else does',
    rarity: 'COMMON',
    trigger: 'TURN_START',
  ...
  },
  {
    id: 'road_warrior',
    name: 'Road Warrior',
    description: 'A van full of merch and zero chill',
    rarity: 'UNCOMMON',
    trigger: 'SHOW_START',
    effects: [{ type: 'ATTENDANCE_PERCENT', value: 15, description: '+15% attendance' }],
    icon: '🛻',
  },
  {
    id: 'sober_living',
    name: 'Straight Edge',
    description: 'A clear head packs the room twice over',
    rarity: 'UNCOMMON',
    trigger: 'SHOW_END',
    effects: [
  ...
  },
  {
    id: 'headliner',
    name: 'Headliner',
    description: 'A name on the marquee carries the night',
    rarity: 'UNCOMMON',
    trigger: 'SHOW_END',
  ...
  },
  {
    id: 'viral_moment',
    name: 'Gone Viral',
    description: 'Someone filmed it and it blew up',
    rarity: 'RARE',
    trigger: 'SHOW_END',
  ...
  },
  {
    id: 'union_rep',
    name: 'Union Rep',
    description: 'Knows the codes, the cops, and a cheaper PA',
    rarity: 'RARE',
    trigger: 'PASSIVE',
    effects: [
  ...
  },
  {
    ...
    description: 'It still sells. It will always sell.',
    rarity: 'LEGENDARY',
    trigger: 'TURN_START',
    effects: [
  ...
  },
  {
    ...
    description: 'When the scene is big enough, you fill a field',
    rarity: 'LEGENDARY',
    trigger: 'SHOW_START',
