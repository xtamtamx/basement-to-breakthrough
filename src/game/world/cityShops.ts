...
const CITY_SHOP_NAMES: Record<string, Partial<Record<ShopKind, string[]>>> = {
  ...
  bostland: {
    [ShopKind.CORNER_STORE]: ["Mike's Pasti-Pit Bakery", 'Modern-ish Pastry Co.', 'The Plaid Pant-Tree', 'Voodoo Doughboy Donuts'],
    [ShopKind.CHAIN_STORE]: ['Powerful Books Megastore', "Dunkin' Dynasty", "Brigham's & Bust"],
    [ShopKind.COFFEE_SHOP]: ['Stumpedtown Coffee', 'Tatte-Tale Bakery', 'George Howl-ell Coffee'],
    [ShopKind.RECORD_STORE]: ['Music Millennium Bug Records', 'Nuggets in the Rough', 'In Yer Eah Records'],
  },
  detroleans: {
    [ShopKind.CORNER_STORE]: ['Verti Smarte 24hr Po-Boys', "Two-Feudin' Coney Islands", "Frady's Faygo One-Stop", 'Better Maid Chip Shack'],
    [ShopKind.CHAIN_STORE]: ['Beignet Buy', 'Coney Barrel', 'Gentriville Galleria'],
    [ShopKind.COFFEE_SHOP]: ["PJ's Chicory Joe", 'Café du Bonde', 'Germack & Beignet'],
    [ShopKind.RECORD_STORE]: ['Fourth Man Records', "Louisiana Music Fact'ry", 'Peachy Keen Records & Tapes'],
  },
  nasheattle: {
    ...
    [ShopKind.COFFEE_SHOP]: ['The First Drip Coffee', 'Bongo Holler Roasters', 'Frothy Possum Coffee'],
    [ShopKind.RECORD_STORE]: ["Phonoluxe Pickin'", 'Sonic Buzz Records', "McKay's Used Wax"],
  },
  chicaustin: {
    [ShopKind.CORNER_STORE]: ['Juan in a Jillion Taco Stand', "Lou Malarkey's Deep-Dish Counter", 'Stubb-Your-Toe BBQ Shack', "Portly Joe's Hot Dog Cart"],
    [ShopKind.CHAIN_STORE]: ['H-E-Buy-More', 'Whatachain Burger', "Buc-ee's Cousin Megamart"],
    [ShopKind.COFFEE_SHOP]: ['Intelligentsketchy Coffee', 'Greater Goods-Enough Roasters', 'Taco-Deli Drip'],
    [ShopKind.RECORD_STORE]: ['Reckful Records', 'Dusty Groove Annex', "Antoinette's Blues Records"],
  },
  atlando: {
    [ShopKind.CORNER_STORE]: ['Awful House', 'Beefy Prince Roast Beef', 'The Varsity Naked Dog', 'The Vortex Skull Burger'],
    [ShopKind.CHAIN_STORE]: ['Ponce-y City Market', 'Publux Supermarket', 'Madame Two-Souvenirs'],
    [ShopKind.COFFEE_SHOP]: ['Drunken Chimp Coffee Bar', 'Credo-It-Yourself Coffee', 'Octane-on-Empty Coffee'],
    [ShopKind.RECORD_STORE]: ['Wuxtry-Buxtry Vinyl', 'Rock & Roll Heavenly', 'Criminal Records & Misdemeanors'],
  },
  santampa: {
    ...
    [ShopKind.COFFEE_SHOP]: ["Fil's Thrash Mission", 'Kahwa Pit Roast', 'Buddy Brewtal'],
    [ShopKind.RECORD_STORE]: ["Rasputin's Riff Vault", 'Vinyl Fever Dream', 'On Broadway Wax'],
  },
  newangeles: {
    [ShopKind.CORNER_STORE]: ['Happy 2 Serve U Deli', '1.50 Dollar-Slice Bros', "Randy's Doughnut-on-the-Roof", 'In-N-Outtake Burger'],
    [ShopKind.CHAIN_STORE]: ['Rodeo Drive-Thru', 'Sunset Strip Mall', 'Gentriffany & Co.'],
    [ShopKind.COFFEE_SHOP]: ['Bricks & Scofflaw', 'Nerve Coffee Roasters', 'Go-Get-Yer Tiger Coffee'],
