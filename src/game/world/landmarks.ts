...
const CITY_LANDMARK_NAMES: Record<string, Record<LandmarkAlignment, string[]>> = {
  ...
  bostland: {
    diy: ['The Whitenoise Haus', 'Jackpot Zine Library', 'All-Ages Almanac Co-op'],
    corporate: ['Spotifly Crystal Arena', 'The Sam Adams-by-Anheuser Pavilion', 'Tatte-Tots Brand Tower'],
    history: ['The Floating Ballroom Floor', 'The Old Citglow Sign', 'Stumptown Stage Plaza'],
  },
  detroleans: {
    diy: ['Wax & Crawfish Records', 'The All-Ages Bayou Co-op', 'Frenchman Zine Library'],
    corporate: ['BrandMotors Soul Arena', 'Faygo-Cola Superdrome', 'Coney-Cola HQ Tower'],
    history: ['The Spirit of Detroleans Statue', "Hitsville Y'all-S.A.", 'The Heidelberg Bounce Project'],
  },
  nasheattle: {
    diy: ["Grimey's Gospel Vinyl", 'Sonic Twang Records Co-op', "The Pickin' Porch Co-op"],
  ...
  chicaustin: {
    ...
    corporate: ['The Badge-Overload Arena', 'Stream-O-Rama Tower', 'Malört-Sponsored Megadome'],
    history: ['The Cloud Burrito', "The Broke'n Spoke Dancehall", 'Cathedral of Junk Mail'],
  },
  atlando: {
    diy: ["Wax'n'Snacks Records", 'Criminally Good Records', 'Park Lane CD-Rs'],
    corporate: ['Auto-Tune Brand Tower', 'Mouseworld Sponsor Dome', 'Hard Pop Live Megaplex'],
    history: ['The Big Chicken Roundabout', 'Patchwork Spaceship Studios', 'Stone Mountain Mixtape Monument'],
  },
  santampa: {
    diy: ['Mojo Riffs & Records', 'Amoeba Swamp', 'La Tercera Zine Bakery'],
    corporate: ['Streamie Sourdome', 'Pabst-Blue-Gator Pavilion', 'Skyway Sponsor-Stays'],
    history: ['The Morrisound Bell', 'The Gillman Graffiti Beam', 'The Skyway Riff-Stay'],
  },
  newangeles: {
